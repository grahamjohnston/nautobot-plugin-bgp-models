# Generated by Django 3.2.13 on 2022-06-20 20:50
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address_family",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="nautobot_bgp_models.addressfamily"
                    ),
                ),
                (
                    "peer_group",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="nautobot_bgp_models.peergroup"),
                ),
                ("tags", taggit.managers.TaggableManager(through="extras.TaggedItem", to="extras.Tag")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "peer_endpoint",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="nautobot_bgp_models.peerendpoint"
                    ),
                ),
                ("tags", taggit.managers.TaggableManager(through="extras.TaggedItem", to="extras.Tag")),
            ],
