...
#             "name": "Peer Group A",
#             "role": self.peeringrole_internal,
#             "source_interface_interface": self.interface_1,
#             "source_interface_vminterface": self.vminterface_1,
#         }
#         form = self.form_class(data)
#         self.assertFalse(form.is_valid())
#         self.assertEqual(
...
#         )
#
#     def test_source_interface_interface(self):
...
#
#     def test_source_interface_vminterface(self):
...
#
#         peergroup = models.PeerGroup.objects.get(name="Peer Group A")
#         self.assertEqual(peergroup.source_interface, self.vminterface_1)
#
#
