...
class BGPRoutingInstanceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.autonomous_system_12345 = models.AutonomousSystem.objects.create(
            asn=12345, status=self.status_active, description="Hello!"
        )
    ...
    def test_str(self):
        ...
        self.assertEqual(str(self.bgp_routing_instance), f"{self.device_1} - {self.autonomous_system_12345}")
...
#         self.peerendpoint_2 = models.PeerEndpoint.objects.create(local_ip=self.ipaddress_2, peering=self.peering)
...
#         models.PeerEndpoint.objects.create(local_ip=address_1, peering=cls.peering)
#         models.PeerEndpoint.objects.create(local_ip=address_2, peering=cls.peering)
#
#     def test_str(self):
#         """Test the string representation of a Peering."""
#         self.assertEqual("1.1.1.1/32 (unknown AS) ↔︎ 2.2.2.2/32 (unknown AS)", str(self.peering))
#
