...
urlpatterns = [
    ...
    path("peer-grouptemplates/", views.PeerGroupTemplateListView.as_view(), name="peergrouptemplate_list"),
    path("peer-grouptemplates/add/", views.PeerGroupTemplateEditView.as_view(), name="peergrouptemplate_add"),
    path("peer-grouptemplates/edit/", views.PeerGroupTemplateBulkEditView.as_view(), name="peergrouptemplate_bulk_edit"),
    path(
        "peer-grouptemplates/delete/",
        views.PeerGroupTemplateBulkDeleteView.as_view(),
        name="peergrouptemplate_bulk_delete",
    ),
    path("peer-grouptemplates/<uuid:pk>/", views.PeerGroupTemplateView.as_view(), name="peergrouptemplate"),
    path("peer-grouptemplates/<uuid:pk>/edit/", views.PeerGroupTemplateEditView.as_view(), name="peergrouptemplate_edit"),
    path("peer-grouptemplates/<uuid:pk>/delete/", views.PeerGroupTemplateDeleteView.as_view(), name="peergrouptemplate_delete"),

    path(
        "peer-grouptemplates/<uuid:pk>/changelog/",
        ObjectChangeLogView.as_view(),
