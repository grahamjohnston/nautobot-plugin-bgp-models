...
class PeerGroupContext(PrimaryModel, InheritanceMixin):
    ...
    property_inheritance = {
        ...
        "multipath": ["address_family", "peer_group", "peer_group.template"],
    }
    ...
    def get_absolute_url(self):
        """Get the URL for detailed view of a single PeerGroupContext."""
        return reverse("plugins:nautobot_bgp_models:peergroupcontext", args=[self.pk])
...
class PeerEndpointContext(PrimaryModel, InheritanceMixin):
    ...
    def get_absolute_url(self):
        """Get the URL for detailed view of a single PeerEndpointContext."""
